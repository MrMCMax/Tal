...
public class ABB<E extends Comparable<E>> {
    ...
    protected NodoABB<E> construirEquilibrado(E[] v, int ini, int fin) {
        ...
        int m = (ini + fin) / 2;
        NodoABB<E> izq = construirEquilibrado(v, ini, m - 1);
        NodoABB<E> der = construirEquilibrado(v, m + 1, fin);
        //res.talla = 1 + talla(res.izq) + talla(res.der); Por si usamos el otro constructor
        return new NodoABB(v[m], izq, der);
    }
